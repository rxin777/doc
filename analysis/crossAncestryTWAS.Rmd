...
[TESLA](https://www.nature.com/articles/s41588-022-01282-x "Multi-ancestry transcriptome-wide association analyses...") works for the case with multiple GWAS and a single eQTL dataset. The idea is to combine the GWAS weights in a way that leverages ancestry information based on allele frequency principal components (PCs). 
