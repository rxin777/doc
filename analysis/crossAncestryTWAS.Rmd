...
data_table <- data.frame(
  "Analysis" = c("1","2","3"),
  "GWAS" = c("AOA", "COA", "COA"),
  "GWAS n(c/ctrl.)" = c("20,702/308,537", "9,613/308,537", "-"),
  "Gwas population" = c("White British", "White British", "-"),
  "eQTL" = c("eQTLGen", "-", "URECA"),
  "eQTL n" = c("31684", "-", "3000"),
  "eQTL tissue" = c("Blood", "-", "Nasal Epithelial"),
  "eQTL population" = c("EUR", "-", "AA"),
  "LD population" = c("EUR", "-", "-")
)
...
ctwas_table <- data.frame(
  "Analysis" = c("1","2","3"),
  "prior group shared" = c("True", "-", "-"),
  "top QTL" = c("True", "-", "-"),
  "total n genes" = c("16987", "16987", "3638"),
  "n genes after harmonization" = c("16703", "16703", "3081"),
  "genes PIP greater 0.8" = c("ENSG00000197536", "ENSG00000106799, ENSG00000138160, ENSG00000134954, ENSG00000265148", "NA")
)
